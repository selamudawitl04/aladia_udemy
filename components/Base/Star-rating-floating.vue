...
<template>
  <div class="star-rating">
    <div class="stars-container" @mouseleave="resetTemp">
      <div
        v-for="index in maxStars"
        :key="index"
        class="star"
        @click="!props.disabled && selectRating(index)"
        @mousemove="!props.disabled && handleMouseMove($event, index)"
      >
...
.star-svg.filled {
  fill: v-bind(fillColor); /* amber-400 */
}
